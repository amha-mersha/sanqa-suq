...
func (repository *ProductRepository) CreateNewReview(ctx context.Context, reviewDTO *dtos.CreateReviewDTO) (*models.Review, error) {
	query := `
		INSERT INTO reviews (
			user_id,
			product_id,
...
func (repository *ProductRepository) UpdateReview(
	ctx context.Context,
	reviewID string,
...
func (repository *ProductRepository) FindReviewByID(ctx context.Context, reviewID string) (*models.Review, error) {
...
func (repository *ProductRepository) DeleteReviewByID(ctx context.Context, reviewID string) error {
