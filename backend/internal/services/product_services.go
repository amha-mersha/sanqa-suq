...
func (service *ProductService) AddNewReview(ctx context.Context, reviewDTO *dtos.CreateReviewDTO) (*models.Review, error) {
...
func (service *ProductService) UpdateReview(ctx context.Context, reviewID string, dto *dtos.UpdateReviewDTO) (*models.Review, error) {
	updateFields := make(map[string]any)
...
func (service *ProductService) GetReview(ctx context.Context, reviewID string) (*models.Review, error) {
	if reviewID == "" {
...
func (service *ProductService) RemoveReview(ctx context.Context, reviewID string) error {
	if reviewID == "" {
